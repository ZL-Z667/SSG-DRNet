...
class SSGDRNet(nn.Module):
    def __init__(self,
        ...
        self.ssgdrnet = SSGDR(in_chans=input_channels,
    ...
    def load_from(self):
        if self.load_ckpt_path is not None:
            ...
            self.vmunet.load_state_dict(model_dict, strict=False)
            print('CrossFusion VSSBlock loaded finished！')
